# Generated by Powerlevel10k configuration wizard on 2025-07-26 at 18:34 -03.
...
typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=40  # 256-color green
  # Red prompt symbol if the last command failed.
typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=196  # 256-color red
  # Default prompt symbol.
typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=''  # Powerline right symbol
...
typeset -g POWERLEVEL9K_DIR_FOREGROUND=33  # 256-color blue
...
typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=39  # 256-color cyan
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=33  # 256-color blue
